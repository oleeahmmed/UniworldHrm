...
urlpatterns = [
    ...
    # Enhanced Employee URLs - Education Level
    path('education-levels/', views.EducationLevelListView.as_view(), name='education_level_list'),
    path('education-levels/create/', views.EducationLevelCreateView.as_view(), name='education_level_create'),
    path('education-levels/<int:pk>/update/', views.EducationLevelUpdateView.as_view(), name='education_level_update'),
    path('education-levels/<int:pk>/delete/', views.EducationLevelDeleteView.as_view(), name='education_level_delete'),
    path('education-levels/export/', views.EducationLevelExportView.as_view(), name='education_level_export'),
    path('education-levels/bulk-delete/', views.EducationLevelBulkDeleteView.as_view(), name='education_level_bulk_delete'),

    # Enhanced Employee URLs - Education Qualification
    path('education-qualifications/', views.EducationQualificationListView.as_view(), name='education_qualification_list'),
    path('education-qualifications/create/', views.EducationQualificationCreateView.as_view(), name='education_qualification_create'),
    path('education-qualifications/<int:pk>/update/', views.EducationQualificationUpdateView.as_view(), name='education_qualification_update'),
    path('education-qualifications/<int:pk>/delete/', views.EducationQualificationDeleteView.as_view(), name='education_qualification_delete'),
    path('education-qualifications/export/', views.EducationQualificationExportView.as_view(), name='education_qualification_export'),
    path('education-qualifications/bulk-delete/', views.EducationQualificationBulkDeleteView.as_view(), name='education_qualification_bulk_delete'),

    # Enhanced Employee URLs - Job Experience
    path('job-experience/', views.JobExperienceListView.as_view(), name='job_experience_list'),
    path('job-experience/create/', views.JobExperienceCreateView.as_view(), name='job_experience_create'),
    path('job-experience/<int:pk>/update/', views.JobExperienceUpdateView.as_view(), name='job_experience_update'),
    path('job-experience/<int:pk>/delete/', views.JobExperienceDeleteView.as_view(), name='job_experience_delete'),
    path('job-experience/export/', views.JobExperienceExportView.as_view(), name='job_experience_export'),
    path('job-experience/bulk-delete/', views.JobExperienceBulkDeleteView.as_view(), name='job_experience_bulk_delete'),

    # Enhanced Employee URLs - Document Type
    ...
    path('document-types/<int:pk>/update/', views.DocumentTypeUpdateView.as_view(), name='document_type_update'),
    path('document-types/<int:pk>/delete/', views.DocumentTypeDeleteView.as_view(), name='document_type_delete'),
    path('document-types/export/', views.DocumentTypeExportView.as_view(), name='document_type_export'),
    path('document-types/bulk-delete/', views.DocumentTypeBulkDeleteView.as_view(), name='document_type_bulk_delete'),

    # Enhanced Employee URLs - Employee Document
    path('employee-documents/', views.EmployeeDocumentListView.as_view(), name='employee_document_list'),
    path('employee-documents/create/', views.EmployeeDocumentCreateView.as_view(), name='employee_document_create'),
    path('employee-documents/<int:pk>/update/', views.EmployeeDocumentUpdateView.as_view(), name='employee_document_update'),
    path('employee-documents/<int:pk>/delete/', views.EmployeeDocumentDeleteView.as_view(), name='employee_document_delete'),
    path('employee-documents/export/', views.EmployeeDocumentExportView.as_view(), name='employee_document_export'),
    path('employee-documents/bulk-delete/', views.EmployeeDocumentBulkDeleteView.as_view(), name='employee_document_bulk_delete'),

    # Enhanced Employee URLs - Family Member
    ...
    path('family-members/<int:pk>/update/', views.FamilyMemberUpdateView.as_view(), name='family_member_update'),
    path('family-members/<int:pk>/delete/', views.FamilyMemberDeleteView.as_view(), name='family_member_delete'),
    path('family-members/export/', views.FamilyMemberExportView.as_view(), name='family_member_export'),
    path('family-members/bulk-delete/', views.FamilyMemberBulkDeleteView.as_view(), name='family_member_bulk_delete'),
